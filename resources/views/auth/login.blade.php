    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <div class="bmd-form-group{{ $errors->has('group') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="group" name="group" class="form-control" placeholder="{{ __('Group...') }}" value="{{ old('group') }}" required>
              </div>
              @if ($errors->has('group'))
                <div id="group-error" class="error text-danger pl-3" for="group" style="display: block;">
